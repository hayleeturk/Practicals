...
special_numbers = [special_number for special_number in numbers if special_number > 9]
...
long_surnames = [name[name.index(" ") + 1:] for name in full_names if len(name) > 11]
print(", ".join(sorted(long_surnames)))
